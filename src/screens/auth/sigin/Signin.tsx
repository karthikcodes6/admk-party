...
const SignIn = ({navigation, signupUserData}: any): React.ReactElement => {
  ...
  return (
    <KeyboardAvoidingView style={styles.container}>
      ...
      <View style={styles.headerContainer}>
        <Text category="h4" status="control" style={GlobalStyles.tAlignCenter}>
          Welcome back to ADMK Party
        </Text>
